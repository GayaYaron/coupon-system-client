...
function CustomerHomeComp(props) {
    ...
    const menuItemList = [
        ...
        <MainMenuItem type="reg" address="" text="Buy" />,
        <MainMenuItem type="reg" address="details" text="Details" />,
        <MainMenuItem type="reg" address="coupons" text="Coupons" />,
...
export const CustomerHomePage = connect(
